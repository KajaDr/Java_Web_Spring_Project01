package pl.cyber.trainess.demo.config;
...
public class Templates {
    ...
    static {
        ...
        reportTemplate = template()
                .setLocale(Locale.forLanguageTag("pl-PL"))
    ...
    public static ComponentBuilder<?, ?> createTitleComponent(String label) {
        return cmp.horizontalList()
                .add(cmp.text(label).setStyle(bold18CenteredStyle).setHorizontalTextAlignment(HorizontalTextAlignment.CENTER))
                .newRow()
                .add(cmp.line())
                .newRow()
     ...
     *
     * @param label a {@link String} object.
     * @return a {@link CurrencyValueFormatter} object.
     */
